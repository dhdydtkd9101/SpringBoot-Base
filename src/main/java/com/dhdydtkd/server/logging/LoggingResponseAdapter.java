...
//		Collection<String> resHeaderNameList = httpServletResponse.getHeaderNames();
//		for (String name : resHeaderNameList) {
//		   resHeaderMap.put(name, httpServletResponse.getHeader(name));
//		}
//		resMap.put("header", resHeaderMap);
